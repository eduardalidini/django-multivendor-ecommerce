...
class Category(models.Model):
    ...
    class Meta:
        ...
        # Rule 5: Indexes for fast category filtering
        indexes = [
...
class Vendor(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.SET_NULL, null=True) # Rule 1: Relational Link to User
    ...
    class Meta:
        ...
        # Rule 5: Indexing vendor title for search
        indexes = [
...
class Product(models.Model):
    ...
    # Rule 3 (Preparation): Used for triggers later
    stock_count = models.IntegerField(default=10, null=True, blank=True) 
    
    life = models.CharField(max_length=100, default="100 Days", null=True, blank=True)
    mfd = models.DateTimeField(auto_now_add=False, null=True, blank=True)

    tags = models.CharField(max_length=100, default="organic", null=True, blank=True)
    ...
    class Meta:
        ...
        # Rule 5: Technical reasoning - Users search by title and sort by price most often
        indexes = [
            models.Index(fields=['title'], name='idx_product_title'),
            models.Index(fields=['price'], name='idx_product_price'),
            models.Index(fields=['product_status'], name='idx_product_status'),
        ]
...
class CartOrder(models.Model):
    ...
    class Meta:
        ...
        # Rule 5: Indexing order date for reporting queries
        indexes = [
